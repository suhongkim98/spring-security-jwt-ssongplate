...
public interface AccountApi {
    ...
    ResponseEntity<CommonResponse<TokenResponseDto>> refreshToken(RefreshTokenRequestDto requestDto);

    @Operation(tags = {"Account"}, summary = "Refresh Token 만료", description = """
            ## API 설명
            해당 유저의 Refresh Token을 만료 시킵니다.
            """)
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "204",
    ...
    ResponseEntity<Void> authorize(String username);
}
