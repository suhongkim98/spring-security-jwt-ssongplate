package com.example.security.jwt.common.config;

import com.example.security.jwt.common.security.handler.JwtAccessDeniedHandler;
import com.example.security.jwt.common.security.handler.JwtAuthenticationEntryPoint;
import com.example.security.jwt.common.security.JwtSecurityConfig;
import com.example.security.jwt.common.security.TokenProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/api/token/refresh").permitAll() // 토큰 갱신 API 도 인증 없이 호출
